      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 flex items-center gap-2">
            <Clock className="text-blue-600" size={32} /> Master Sesi Waktu
          </h1>
          <p className="text-gray-500 mt-1">Kelola slot jam pelajaran KBM per harinya secara dinamis.</p>
        </div>
        <button 
          onClick={() => setIsAdding(!isAdding)}
          className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-semibold shadow-md flex items-center gap-2 transition-all"
        >
          {isAdding ? "Batal" : <><Plus size={18} /> Tambah Sesi</>}
        </button>
      </div>
