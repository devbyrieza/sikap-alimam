...
async function executeSync(simpegGuruList: any[]) {
  ...
  for (const guru of simpegGuruList) {
    try {
      ...
      // Fitur Auto-mapping dihapus.
      // Sesuai arsitektur baru, AsatidzmMapel dikelola mandiri di SIKAP via menu Distribusi Mengajar.
      // SIMPEG hanya bertugas mengirim NAMA dan NIK guru, tidak lagi mendikte jadwal/kelasnya.
